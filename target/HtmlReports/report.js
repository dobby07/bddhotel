...
formatter.uri("file:src/test/resources/Features/usuarios.feature");
formatter.feature({
  "name": "Funcionalidad para probar la gestión de usuarios",
  "description": "",
  "keyword": "Feature"
});
formatter.scenario({
...
formatter.step({
  "name": "no hay usuarios registrados",
  "keyword": "Given "
});
formatter.match({});
formatter.result({
...
formatter.step({
  "name": "se agrega un usuario con DNI \"12345678\", clave \"password123\", nombre \"John\", apellido \"Doe\", email \"john.doe@example.com\", teléfono \"123456789\", estado \"Activo\" y cargo \"1\"",
  "keyword": "When "
});
formatter.match({});
formatter.result({
...
formatter.step({
  "name": "la lista de usuarios debe contener un usuario",
  "keyword": "Then "
});
formatter.match({});
formatter.result({
...
formatter.step({
  "name": "el usuario debe tener los detalles correctos",
  "keyword": "And "
});
formatter.match({});
formatter.result({
...
formatter.step({
  "name": "hay un usuario con DNI \"87654321\", clave \"oldpassword\", nombre \"Jane\", apellido \"Doe\", email \"jane.doe@example.com\", teléfono \"987654321\", estado \"Activo\" y cargo \"2\"",
  "keyword": "Given "
});
formatter.match({});
formatter.result({
...
formatter.step({
  "name": "se modifica el usuario con DNI \"87654321\" con nuevos detalles",
  "keyword": "When "
});
formatter.match({});
formatter.result({
...
formatter.step({
  "name": "el usuario debe tener los detalles modificados",
  "keyword": "Then "
});
formatter.match({});
formatter.result({
...
formatter.scenario({
  "name": "Eliminar un usuario existente",
  "description": "",
  "keyword": "Scenario"
});
formatter.step({
  "name": "hay un usuario con DNI \"55555555\", clave \"deletepassword\", nombre \"Alice\", apellido \"Smith\", email \"alice.smith@example.com\", teléfono \"555555555\", estado \"Activo\" y cargo \"3\"",
  "keyword": "Given "
});
formatter.match({});
formatter.result({
...
formatter.step({
  "name": "se elimina el usuario con DNI \"55555555\"",
  "keyword": "When "
});
formatter.match({});
formatter.result({
...
formatter.step({
  "name": "la lista de usuarios no debe contener al usuario eliminado",
  "keyword": "Then "
});
formatter.match({});
formatter.result({
...
formatter.scenario({
  "name": "Validar inicio de sesión del usuario",
  "description": "",
  "keyword": "Scenario"
});
formatter.step({
  "name": "hay un usuario con DNI \"99999999\", clave \"loginpassword\", nombre \"Bob\", apellido \"Johnson\", email \"bob.johnson@example.com\", teléfono \"999999999\", estado \"Activo\" y cargo \"1\"",
  "keyword": "Given "
});
formatter.match({});
formatter.result({
...
formatter.step({
  "name": "el usuario con DNI \"99999999\" valida el inicio de sesión con clave \"loginpassword\"",
  "keyword": "When "
});
formatter.match({});
formatter.result({
...
formatter.step({
  "name": "la validación del inicio de sesión debe ser exitosa",
  "keyword": "Then "
});
formatter.match({});
formatter.result({
